# FILE AUTOMATICALLY GENERATED FROM /Users/sc/.config/zsh/.zimrc
# EDIT THE SOURCE FILE AND THEN RUN zimfw build. DO NOT DIRECTLY EDIT THIS FILE!

if [[ -e ${ZIM_CONFIG_FILE:-${ZDOTDIR:-${HOME}}/.zimrc} ]] zimfw() { source "${HOME}/.config/zsh/zimfw.zsh" "${@}" }
fpath=("${HOME}/.config/zsh/modules/completion/functions" "${HOME}/.config/zsh/modules/prompt-pwd/functions" "${HOME}/.config/zsh/modules/utility/functions" "${HOME}/.config/zsh/modules/git-info/functions" ${fpath})
...
source "${HOME}/.config/zsh/modules/fzf-tab/fzf-tab.zsh"
